...
```sh
git clone git@github.com:HNO333333/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone git@github.com:HNO333333/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```
